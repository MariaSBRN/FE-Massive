...
import FertilizerCard from "../../Components/PupukCard/PupukCard";
import Footer from "../../Components/Footer/Footer";
import styles from "./PupukSubsidi.module.css";
      ...
      <header className={styles.hero}>
        ...
        <div className={styles.heroContent}>
          ...
          <h1 className={styles.heroTitle}>
            Pemerintah Bantu Berikan Pupuk Subsidi Terbaik untuk Desa
          </h1>
      ...
      {showConfirmation && selectedFertilizer && (
        <div className={styles.popupContainer}>
          <div className={styles.popup}>
            ...
            <p>
              Biaya Potong Subsidi: Rp{" "}
              {selectedFertilizer.price.toLocaleString()}
            </p>
            <p>Tanggal Pencairan: {selectedFertilizer.date}</p>
            <p>Jumlah Max/Anggota: {selectedFertilizer.maxMembers} Anggota</p>
          ...
          <div className={styles.contentWrapper}>
            <div className={styles.messageContainer}>
              ...
              <h2 id="modalTitle" className={styles.successMessage}>
                Pupuk Subsidi berhasil diambil!
              </h2>
            </div>
            <button
